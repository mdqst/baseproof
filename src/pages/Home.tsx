  ...
  return (
    <div style={{ maxWidth: 960, margin: '0 auto', padding: 32 }}>
      <header style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 28, fontWeight: 600 }}>BaseProof — WalletConnect + Native Mint</h1>
        <p style={{ color: '#475569' }}>Connect your wallet, then mint directly via ethers.js on Base Sepolia.</p>
      </header>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
        ...
        <section style={{ background: '#fff', padding: 16, borderRadius: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
          ...
          <p style={{ fontSize: 14, color: '#475569' }}>This calls a common mint() signature on your contract.</p>
